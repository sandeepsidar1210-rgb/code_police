...
const ShaderCanvas = () => {
    ...
    const [backgroundColor, setBackgroundColor] = useState([0, 0, 0]); // dark by default
    ...
    useEffect(() => {
        ...
        updateColor();
        // Default to dark since Protocol Zero is a dark theme app
...
export const PricingCard = ({
    planName, description, price, features, buttonText, buttonHref = '/sign-up', isPopular = false, buttonVariant = 'primary'
}: PricingCardProps) => {
    const cardClasses = `
    ...
    return (
        <div className={cardClasses.trim()}>
            ...
            <div className="my-6 flex items-baseline gap-2">
                ...
                {price !== '0' && <span className="text-[14px] text-foreground/70 font-sans">/mo</span>}
            </div>
...
// --- EXPORTED Pricing Section Component (embedded, not full-page) --- //
...
export const AnimatedGlassyPricing = ({
    ...
    return (
        <div className="relative w-full overflow-hidden rounded-2xl">
            {/* Animated WebGL background (contained within the section) */}
            ...
            <div className="relative z-10 w-full flex flex-col items-center justify-center px-4 py-16">
                {/* Heading */}
                <div className="w-full max-w-5xl mx-auto text-center mb-14">
                    <h2 className="text-[40px] md:text-[56px] font-extralight leading-tight tracking-[-0.03em] bg-clip-text text-transparent bg-gradient-to-r from-white via-cyan-300 to-blue-400 font-display">
                        Pricing that Scales with You
                    </h2>
                    <p className="mt-3 text-[16px] md:text-[18px] text-white/70 max-w-2xl mx-auto font-sans">
                ...
                {/* Pricing Cards */}
                <div className="flex flex-col md:flex-row gap-8 md:gap-6 justify-center items-center w-full max-w-3xl">
...
export default AnimatedGlassyPricing;
