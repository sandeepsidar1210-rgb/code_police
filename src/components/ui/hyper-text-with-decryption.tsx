    ...
    return (
      ...
      `}
            ...
            animate={{
                ...
                color: isHovered ? "#FFFFFF" : isHighlightable ? highlightColor : defaultColor,
                ...
                {isHovered && (
                    <>
                        <motion.span
                            ...
                            animate={{ scale: 1 }}
                            exit={{ scale: 0 }}
                            className="absolute -top-1 -right-1 w-2 h-2 bg-purple-500 rounded-full z-20"
                        />
                        <motion.span
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            exit={{ scale: 0 }}
                            className="absolute -bottom-1 -left-1 w-2 h-2 bg-cyan-500 rounded-full z-20"
                        />
                    </>
                )}
            </AnimatePresence>
